...
// node_modules/i18next-intervalplural-postprocessor/dist/es/index.js
  ...
  process: function process(value, key, options, translator) {
    ...
    if (!found) {
      ...
      if (typeof newOptions.postProcess === "string") {
        ...
        var index = newOptions.postProcess.indexOf("interval");
        if (index !== -1)
          newOptions.postProcess.splice(index, 1);
      }
      var newKeys = void 0;
      ...
      if (newKeys)
        found = translator.translate(newKeys, newOptions);
    }
    return found || value;
  }
};
...
//# sourceMappingURL=i18next-intervalplural-postprocessor.js.map
